...
common_reply = ["Big oumff", "oumff", "moua", "ouais ouais supère", "J'aime bien le froumage",
 ...
 "okok j'ai une ostie de bonne idée\nun bidet... au froumage", "SES MOUA QUI A LES ZEU OKER"]

insultes = ["Fais pas ta tapet", "Criss de centriste", "Ferme ta criss de gueule", 
"lmak ton manteau sent beaucoup trop le weed", "Tayeule gros fif", "T'es juste une moumoune", "j'ai 4 matchs avec des tsites inchaudes tinedeur"]
